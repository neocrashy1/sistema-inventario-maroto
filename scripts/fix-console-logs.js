...
function replaceLogs(content) {
  // avoid replacing console in comments or strings crudely; we'll do a simple regex that handles most cases
  // Replace console.error/warn/log followed by space/newline and (
